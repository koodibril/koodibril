...
export class CustomLoadingScreen implements ILoadingScreen {
  ...
  public readyUIDiv(): void {
    ...
    if (mobile) {
      ...
      imgleft.src = "/images/DoubleTap.svg";
    } else {
      subleft.innerHTML = "Click to<br>select a project";
      imgleft.src = "/images/Tap.svg";
    }
    ...
    imgright.src = "/images/Scroll-Vertical.svg";
    ...
    if (mobile && !nav) {
      ...
      subright.style.fontSize = "25px";
      subright.innerHTML =
        "Currently mobile is not supported. Please visit on a desktop for a full experience";
